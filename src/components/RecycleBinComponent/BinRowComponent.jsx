...
const BinRowComponent = ({ file }) => {
    ...
    return (
        <tr className="mx-2 border-t h-12 cursor-pointer hover:bg-[#eae8e8] group">
            ...
            <td className="w-[15%] max-w-[100px] px-4 py-2 truncate whitespace-nowrap overflow-hidden text-ellipsis">{file.deletedDate}</td>
            <td className="w-[15%] max-w-[100px] px-4 py-2 truncate whitespace-nowrap overflow-hidden text-ellipsis">{file.size}</td>
        </tr>
    )
}

export default BinRowComponent